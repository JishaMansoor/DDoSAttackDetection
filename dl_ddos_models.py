...
#Model Training :python3 dl_ddos_models.py  --train ~/final_data_syn --modelname CONVLSTM1D

# Model Testing
#python3 dl_ddos_models.py --predict ./final_dataset/ --model ./output/10t-10n-IDS201X-CONVLSTM1D.h5
