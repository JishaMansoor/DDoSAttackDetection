# Code for Global Max pool base Models.
# Author: Jisha C U
...
#Model Training :python3 dl_ddos_models_max_pool.py  --train ~/final_dataset --modelname LSTM_ATTN

# Model Testing
#python3 dl_ddos_models_max_pool.py --predict ./final_dataset/ --model ./output/10t-10n-IDS201X-GM_LSTM_ATTN.h5
